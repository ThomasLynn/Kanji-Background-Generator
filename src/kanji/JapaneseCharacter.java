...
/**
 * JapaneseCharacter contains static functions to do various tests on characters
 * to determine if it is one of the various types of characters used in the
 ...
 *
 * @see <a href=
 *      "http://sourceforge.net/projects/kanjixml/">http://sourceforge.net/projects/kanjixml/</a>
 */
public class JapaneseCharacter {
	...
	public static String convertToKatakana(String input) {
		...
		for (int i = 0; i < input.length(); i++) {
			if (JapaneseCharacter.isKatakana(input.charAt(i))) {
	 ...
	 * function only operates on Hiragana and always returns the Full width version
	 * of the Katakana. If the character is outside the Hiragana then the origianal
	 ...
	 * function only operates on Katakana characters If the character is outside the
	 * Full width or Half width Katakana then the origianal character is returned.
	 */
	...
	/**
	 * Translates this character into the equivalent Romaji character. The function
	 * only operates on Hiragana and Katakana characters If the character is outside
	 * the given range then the origianal character is returned.
	 * <p/>
	 * The resulting string is lowercase if the input was Hiragana and UPPERCASE if
	 * the input was Katakana.
	 */
